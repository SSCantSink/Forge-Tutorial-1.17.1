...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    // just like the ArmorMaterials class, we have this guy here.
    TITANIUM("titanium", 50, new int[]{3, 6, 8, 3}, 5, SoundEvents.ARMOR_EQUIP_NETHERITE,
            4.0F, 0.2F, () -> {
        return Ingredient.of(ModItems.TITANIUM_INGOT.get());
    });

    // durability sort of hardcoded, ordered by boots, leggings, chestplate, helmet.
    ...
    // gotta change this if your texture models are not in the minecraft folder.
